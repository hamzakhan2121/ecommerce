import {
    ...
    ALL_REVIEW_REQUEST ,ALL_REVIEW_SUCCESS,ALL_REVIEW_FAIL,DELETE_REVIEW_REQUEST,DELETE_REVIEW_SUCCESS,DELETE_REVIEW_FAIL,DELETE_REVIEW_RESET
...
//Review Reducer
export const newReivewReducer = (state = {}, action) => {
    switch (action.type) {
